...
public class StringBasic {
    public static void main(String[] args) {
        ...
        // equals() : 두개의 문자열을 비교하여 결과값을 리턴, 오버라이딩 되어있음
        ...
        System.out.println(text3.indexOf("Prog"));  // 5  그런데 없는 글자이면 -1
        ...
        System.out.println(text3.replace(" ", "")); // 공백
        // replaceAll() 은 정규 표현식

        // substring() : 문자열에서 특정 문자열을 추출할 때 사용
        System.out.println(text3.substring(5));  // 5번 인덱스에서 끝까지
        System.out.println(text3.substring(5 ,10));  // 5에서 10 미만까지 추출
