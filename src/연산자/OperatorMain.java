...
public class OperatorMain {
    public static void main(String[] args) {
        ...
        System.out.println(x - y);
        System.out.println(x * y);
        System.out.println(x / y);  // 나눗셈이 아니고 몫을 구하는 연산이 됨
        ...
        // 논리연산자
        int num5 = 10, num6 = 20;
        System.out.println(num5 > 0 && num5 > num6);  // 산술연산자가 논리연산자보다 우선 순위가 높음, flase
        System.out.println(num5 > 0 || num5 > num6);  // true
        System.out.println(!(num5 > 0 || num5 > num6));  // flase

        // 3항연산자 : 참과 거짓만 있는 조건문 대체
        Scanner sc = new Scanner(System.in);
        System.out.print("나이 입력 : ");
        int age = sc.nextInt(); // 스캐너 객체로부터 나이를 입력 받음
//        if (age >= 18) {
